...
string getDefaultVertexShaderPath() {
    return "/home/mlgmag/CLionProjects/graphicsLabs/src/light/color/shaders/defaultVertex.shader";
}

string getDefaultFragmentShaderPath() {
    return "/home/mlgmag/CLionProjects/graphicsLabs/src/light/color/shaders/defaultFragment.shader";

}

string getLightSourceFragmentShaderPath() {
    return "/home/mlgmag/CLionProjects/graphicsLabs/src/light/color/shaders/lightSourceFragment.shader";
}
